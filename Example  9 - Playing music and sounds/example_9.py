...
# Load game sounds from different audio files
hoot_sound   = pygame.mixer.Sound("hoot.mp3")
...
while game_running:
    ...
    if game_over:
        ...
        if player_rect.collidepoint(token_rect.center):
            ...
            # Play a sound when the player's score increases
        ...
        if enemy_rect.collidepoint(player_rect.center):
            ...
            # Play a sound when the player's health decreases
